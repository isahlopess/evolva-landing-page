                        ...
                        <div class="flex">
                            <div class="flex shrink-0 items-center">
                                <Link :href="route('dashboard')">
                                    <div class="flex items-center space-x-2 text-xl font-extrabold text-indigo-600">
                                        <img src="/images/favicon-32x32.png" alt="Evolva Logo" class="h-6 w-6">
                                        <span class="dark:text-indigo-400">Evolva</span>
                                    </div>
                                </Link>
                            </div>
                            ...
                            >
                                <NavLink
                                    ...
                                    class="dark:text-gray-300 dark:hover:text-white dark:focus:text-white dark:hover:border-indigo-400"
                                >
                                    Dashboard
                                </NavLink>
                            </div>
